...
#                          Helper Functions 
#====================================================================
CLFLAGS:= --xp "param:compiler.preserveHlsOutput=1" \
...
$(XCLBIN_DIR)/$(1).$(2).xo: $($(1)_SRCS) $($(1)_HDRS) 
	mkdir -p ${XCLBIN_DIR}
	$(CLCC) -c $(CLFLAGS) $($(1)_CFLAGS) -o $$@ -t $(2) --platform ${XDEVICE} $($(1)_SRCS)
endef
...
$(XCLBIN_DIR)/${XCLBIN}: $(addprefix $(XCLBIN_DIR)/,$(addsuffix .$(2).xo, $(XOS))) 
	...
	$(CLCC) -l $(CLFLAGS) $(XCLBIN_LFLAGS)  -o $$@\
			-t $(2) --platform ${XDEVICE} $(addprefix $(XCLBIN_DIR)/,$(addsuffix .$(2).xo, $(XOS)))
endef
...
clean:
	${RM} -rf ${HOST_EXE} ${OBJECTS} ${XCLBIN} emconfig.json _xocc_${XCLBIN_NAME}_*.dir .Xil\
						 packaged_kernel_* tmp_kernel_pack_*
