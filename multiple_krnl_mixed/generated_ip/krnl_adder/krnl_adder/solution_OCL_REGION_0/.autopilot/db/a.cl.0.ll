...
@krnl_adder.tmp_b = internal addrspace(3) global i32 0, align 4 ; [#uses=1 type=i32 addrspace(3)*]
@krnl_adder.sum = internal addrspace(3) global i32 0, align 4 ; [#uses=1 type=i32 addrspace(3)*]
@krnl_write.rd_c = internal addrspace(3) global i32 0, align 4 ; [#uses=0 type=i32 addrspace(3)*]
@krnl_write.tmp = internal addrspace(3) global i32 0, align 4 ; [#uses=0 type=i32 addrspace(3)*]
...
; [#uses=1]
declare spir_func void @_ssdm_StreamWrite(...) nounwind
...
; [#uses=0]
define spir_func void @krnl_adder(i32 addrspace(1)* %gmem, i32 addrspace(4)* %pipe_a, i32 %pipe_a_count, i32 addrspace(4)* %pipe_b, i32 %pipe_b_count, i32 addrspace(4)* %pipe_c, i32 %pipe_c_count, %struct.krnl_adder_args_t* %args) {
  ...
  call spir_func void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str5, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8]* @.str6, i32 0, i32 0), i32* %4) nounwind, !dbg !140 ; [debug line = 29:5@55:1]
  %5 = getelementptr inbounds %struct.krnl_adder_args_t* %args, i32 0, i32 1, !dbg !142 ; [#uses=1 type=i64*] [debug line = 30:5@55:1]
  call spir_func void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str5, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8]* @.str7, i32 0, i32 0), i64* %5) nounwind, !dbg !142 ; [debug line = 30:5@55:1]
  %6 = getelementptr inbounds %struct.krnl_adder_args_t* %args, i32 0, i32 2, !dbg !143 ; [#uses=1 type=i64*] [debug line = 31:5@55:1]
  call spir_func void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str5, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8]* @.str8, i32 0, i32 0), i64* %6) nounwind, !dbg !143 ; [debug line = 31:5@55:1]
  %7 = getelementptr inbounds %struct.krnl_adder_args_t* %args, i32 0, i32 3, !dbg !144 ; [#uses=1 type=i64*] [debug line = 32:5@55:1]
  call spir_func void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str5, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8]* @.str9, i32 0, i32 0), i64* %7) nounwind, !dbg !144 ; [debug line = 32:5@55:1]
  call spir_func void (...)* @_ssdm_op_SpecInterface(i32 addrspace(4)* %pipe_a, i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !145 ; [debug line = 56:1]
  call spir_func void (...)* @_ssdm_op_SpecInterface(i32 addrspace(4)* %pipe_b, i8* getelementptr inbounds ([5 x i8]* @.str, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !146 ; [debug line = 57:1]
...
; <label>:131                                     ; preds = %129
  %pipe_a_count17.i.i = call spir_func i32 @_ssdm_op_Read.ap_auto.i32(i32 %pipe_a_count) nounwind ; [#uses=1 type=i32]
  %132 = icmp ugt i32 %pipe_a_count17.i.i, 1      ; [#uses=1 type=i1]
  br i1 %132, label %133, label %134

; <label>:133                                     ; preds = %131
  call spir_func void (...)* @_ssdm_StreamRead(i32 addrspace(4)* %pipe_a, i32* %3) nounwind
  br label %__xcl_read_pipe.exit.i.i

; <label>:134                                     ; preds = %131
  %pipe_a_count18.i.i = call spir_func i32 @_ssdm_op_Read.ap_auto.i32(i32 %pipe_a_count) nounwind ; [#uses=1 type=i32]
...
__xcl_read_pipe.exit.i.i:                         ; preds = %136, %134, %133
  ...
  store i32 %pipe_data.i.i, i32 addrspace(3)* @krnl_adder.tmp_a, align 4
  store i32 %.04.reg2mem.0.i.i, i32 addrspace(3)* @krnl_adder.rd_a, align 4, !dbg !195 ; [debug line = 38:4]
  %pipe_b_count19.i.i = call spir_func i32 @_ssdm_op_Read.ap_auto.i32(i32 %pipe_b_count) nounwind ; [#uses=1 type=i32]
  %137 = icmp ugt i32 %pipe_b_count19.i.i, 1      ; [#uses=1 type=i1]
  br i1 %137, label %138, label %139

; <label>:138                                     ; preds = %__xcl_read_pipe.exit.i.i
  call spir_func void (...)* @_ssdm_StreamRead(i32 addrspace(4)* %pipe_b, i32* %2) nounwind
  br label %__xcl_read_pipe.exit1.i.i

; <label>:139                                     ; preds = %__xcl_read_pipe.exit.i.i
  %pipe_b_count20.i.i = call spir_func i32 @_ssdm_op_Read.ap_auto.i32(i32 %pipe_b_count) nounwind ; [#uses=1 type=i32]
...
__xcl_read_pipe.exit1.i.i:                        ; preds = %141, %139, %138
  ...
  store i32 %pipe_data2.i.i, i32 addrspace(3)* @krnl_adder.tmp_b, align 4
  store i32 %.08.reg2mem.0.i.i, i32 addrspace(3)* @krnl_adder.rd_b, align 4, !dbg !197 ; [debug line = 39:5]
  %142 = load i32 addrspace(3)* @krnl_adder.tmp_a, align 4, !dbg !198 ; [#uses=1 type=i32] [debug line = 40:5]
  %143 = add nsw i32 %142, %pipe_data2.i.i, !dbg !198 ; [#uses=2 type=i32] [debug line = 40:5]
  store i32 %143, i32 addrspace(3)* @krnl_adder.sum, align 4, !dbg !198 ; [debug line = 40:5]
  store i32 %143, i32* %1, align 4
  %pipe_c_count21.i.i = call spir_func i32 @_ssdm_op_Read.ap_auto.i32(i32 %pipe_c_count) nounwind ; [#uses=1 type=i32]
...
; <label>:145                                     ; preds = %__xcl_read_pipe.exit1.i.i
  call spir_func void (...)* @_ssdm_StreamWrite(i32 addrspace(4)* %pipe_c, i32* %1) nounwind
...
__xcl_write_pipe.exit.i.i:                        ; preds = %145, %__xcl_read_pipe.exit1.i.i
  ...
  store i32 %.0.reg2mem.0.i.i, i32 addrspace(3)* @krnl_adder.wr_c, align 4, !dbg !199 ; [debug line = 41:5]
