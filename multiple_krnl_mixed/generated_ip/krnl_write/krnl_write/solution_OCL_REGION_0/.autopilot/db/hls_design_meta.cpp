...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("pipe_c_TDATA", 32, hls_in, 1, "axis", "in_data", 1),
	Port_Property("pipe_c_TVALID", 1, hls_in, 1, "axis", "in_vld", 1),
	Port_Property("pipe_c_TREADY", 1, hls_out, 1, "axis", "in_acc", 1),
	Port_Property("pipe_c_count", 32, hls_in, 2, "ap_none", "in_data", 1),
...
const char* HLS_Design_Meta::dut_name = "krnl_write";
