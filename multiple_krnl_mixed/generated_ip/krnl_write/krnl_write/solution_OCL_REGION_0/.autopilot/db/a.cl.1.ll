...
@krnl_write.rd_c = internal  global i32 0, align 4 ; [#uses=1 type=i32 *]
@krnl_write.tmp = internal  global i32 0, align 4 ; [#uses=1 type=i32 *]
...
; [#uses=0]
define  void @krnl_write(i32 addrspace(1)* %gmem, i32 addrspace(4)* %pipe_c, i32 %pipe_c_count, %struct.krnl_write_args_t* %args) {
  ...
  call  void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str5, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8]* @.str6, i32 0, i32 0), i64* %2) nounwind, !dbg !125 ; [debug line = 28:5@54:1]
  %3 = getelementptr inbounds %struct.krnl_write_args_t* %args, i32 0, i32 1, !dbg !127 ; [#uses=1 type=i32*] [debug line = 29:5@54:1]
  call  void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str5, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8]* @.str7, i32 0, i32 0), i32* %3) nounwind, !dbg !127 ; [debug line = 29:5@54:1]
  %4 = getelementptr inbounds %struct.krnl_write_args_t* %args, i32 0, i32 2, !dbg !128 ; [#uses=1 type=i64*] [debug line = 30:5@54:1]
  call  void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str5, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8]* @.str8, i32 0, i32 0), i64* %4) nounwind, !dbg !128 ; [debug line = 30:5@54:1]
...
; <label>:129                                     ; preds = %127
  %pipe_c_count12.i.i = call  i32 @_ssdm_op_Read.ap_auto.i32(i32 %pipe_c_count) nounwind ; [#uses=1 type=i32]
  %130 = icmp ugt i32 %pipe_c_count12.i.i, 1      ; [#uses=1 type=i1]
  br i1 %130, label %131, label %132

; <label>:131                                     ; preds = %129
  call  void (...)* @_ssdm_StreamRead(i32 addrspace(4)* %pipe_c, i32* %1) nounwind
  br label %__xcl_read_pipe.exit.i.i

; <label>:132                                     ; preds = %129
  %pipe_c_count13.i.i = call  i32 @_ssdm_op_Read.ap_auto.i32(i32 %pipe_c_count) nounwind ; [#uses=1 type=i32]
...
__xcl_read_pipe.exit.i.i:                         ; preds = %134, %132, %131
  ...
  store i32 %pipe_data.i.i, i32 * @krnl_write.tmp, align 4
  store i32 %.0.reg2mem.0.i.i, i32 * @krnl_write.rd_c, align 4, !dbg !176 ; [debug line = 54:4]
