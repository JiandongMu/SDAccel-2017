...
HD_PWD='/home/yanghui/Desktop/myProject/multiple_krnl/_xocc_compile_krnl_vadd_krnl_vadd.hw_emu.dir/impl/kernels/krnl_read'
cd "$HD_PWD"
...
EAStep vivado_hls -f krnl_read.tcl -messageDb vivado_hls.pb
