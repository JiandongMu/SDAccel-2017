...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("pipe_a_TDATA", 32, hls_out, 1, "axis", "out_data", 1),
	Port_Property("pipe_a_TVALID", 1, hls_out, 1, "axis", "out_vld", 1),
	Port_Property("pipe_a_TREADY", 1, hls_in, 1, "axis", "out_acc", 1),
	Port_Property("pipe_a_count", 32, hls_in, 2, "ap_none", "in_data", 1),
	Port_Property("pipe_b_TDATA", 32, hls_out, 3, "axis", "out_data", 1),
	Port_Property("pipe_b_TVALID", 1, hls_out, 3, "axis", "out_vld", 1),
	Port_Property("pipe_b_TREADY", 1, hls_in, 3, "axis", "out_acc", 1),
...
const char* HLS_Design_Meta::dut_name = "krnl_read";
