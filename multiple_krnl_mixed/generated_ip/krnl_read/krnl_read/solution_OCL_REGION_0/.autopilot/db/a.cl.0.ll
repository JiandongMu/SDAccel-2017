...
@krnl_read.tmp_a = internal addrspace(3) global i32 0, align 4 ; [#uses=1 type=i32 addrspace(3)*]
...
; [#uses=0]
define spir_func void @krnl_read(i32 addrspace(1)* %gmem, i32 addrspace(4)* %pipe_a, i32 %pipe_a_count, i32 addrspace(4)* %pipe_b, i32 %pipe_b_count, %struct.krnl_read_args_t* %args) {
  ...
  call spir_func void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str5, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8]* @.str6, i32 0, i32 0), i64* %3) nounwind, !dbg !137 ; [debug line = 30:5@59:1]
  %4 = getelementptr inbounds %struct.krnl_read_args_t* %args, i32 0, i32 1, !dbg !139 ; [#uses=1 type=i64*] [debug line = 31:5@59:1]
  call spir_func void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str5, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8]* @.str7, i32 0, i32 0), i64* %4) nounwind, !dbg !139 ; [debug line = 31:5@59:1]
  %5 = getelementptr inbounds %struct.krnl_read_args_t* %args, i32 0, i32 2, !dbg !140 ; [#uses=1 type=i32*] [debug line = 32:5@59:1]
  call spir_func void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str5, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8]* @.str8, i32 0, i32 0), i32* %5) nounwind, !dbg !140 ; [debug line = 32:5@59:1]
  %6 = getelementptr inbounds %struct.krnl_read_args_t* %args, i32 0, i32 3, !dbg !141 ; [#uses=1 type=i64*] [debug line = 33:5@59:1]
  call spir_func void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str5, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8]* @.str9, i32 0, i32 0), i64* %6) nounwind, !dbg !141 ; [debug line = 33:5@59:1]
  %7 = getelementptr inbounds %struct.krnl_read_args_t* %args, i32 0, i32 4, !dbg !142 ; [#uses=1 type=i64*] [debug line = 34:5@59:1]
  call spir_func void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str5, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8]* @.str10, i32 0, i32 0), i64* %7) nounwind, !dbg !142 ; [debug line = 34:5@59:1]
  ...
  call spir_func void (...)* @_ssdm_op_SpecInterface(%struct.krnl_read_args_t* %args, i8* getelementptr inbounds ([10 x i8]* @.str3, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([8 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !147 ; [debug line = 64:1]
...
; <label>:136                                     ; preds = %134
  ...
  store i32 %139, i32 addrspace(3)* @krnl_read.tmp_a, align 4, !dbg !194 ; [debug line = 24:7]
  ...
  store i32 %142, i32 addrspace(3)* @krnl_read.tmp_b, align 4, !dbg !196 ; [debug line = 25:7]
  store i32 %139, i32* %2, align 4
  %pipe_a_count16.i.i = call spir_func i32 @_ssdm_op_Read.ap_auto.i32(i32 %pipe_a_count) nounwind ; [#uses=1 type=i32]
  %143 = icmp ult i32 %pipe_a_count16.i.i, 128    ; [#uses=1 type=i1]
  br i1 %143, label %144, label %__xcl_write_pipe.exit.i.i

; <label>:144                                     ; preds = %136
  call spir_func void (...)* @_ssdm_StreamWrite(i32 addrspace(4)* %pipe_a, i32* %2) nounwind
...
__xcl_write_pipe.exit.i.i:                        ; preds = %144, %136
  ...
  store i32 %.04.reg2mem.0.i.i, i32 addrspace(3)* @krnl_read.wr_a, align 4, !dbg !197 ; [debug line = 26:6]
  %pipe_data2.i.i = load i32 addrspace(3)* @krnl_read.tmp_b, align 4 ; [#uses=1 type=i32]
  store i32 %pipe_data2.i.i, i32* %1, align 4
  %pipe_b_count17.i.i = call spir_func i32 @_ssdm_op_Read.ap_auto.i32(i32 %pipe_b_count) nounwind ; [#uses=1 type=i32]
...
; <label>:146                                     ; preds = %__xcl_write_pipe.exit.i.i
  call spir_func void (...)* @_ssdm_StreamWrite(i32 addrspace(4)* %pipe_b, i32* %1) nounwind
...
__xcl_write_pipe.exit1.i.i:                       ; preds = %146, %__xcl_write_pipe.exit.i.i
  ...
  store i32 %.0.reg2mem.0.i.i, i32 addrspace(3)* @krnl_read.wr_b, align 4, !dbg !198 ; [debug line = 27:7]
