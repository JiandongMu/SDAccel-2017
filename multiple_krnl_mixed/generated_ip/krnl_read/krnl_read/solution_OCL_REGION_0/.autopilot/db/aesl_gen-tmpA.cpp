...
/* KernelID: A, Kernel Name: krnl_read */
...
public:
  ...
  aesl_keep_name_0_args(krnl_read_args_t* args) {
    _ssdm_op_SpecExt("member_name", "a", &args->a);
    _ssdm_op_SpecExt("member_name", "b", &args->b);
...
void
__AESL_call_work_item_NA(volatile __attribute__((address_space(16776960))) unsigned int* gmem,   volatile __attribute__((address_space(16776963))) unsigned int* pipe_a,   unsigned int pipe_a_count,   volatile __attribute__((address_space(16776963))) unsigned int* pipe_b,   unsigned int pipe_b_count, __spir_rt_info_t *rt_info, krnl_read_args_t *args)
{
  volatile __attribute__((address_space(16776960))) unsigned int *arg_a = (gmem + ((XCL_SIZE_T)args->a >> 2));
  volatile __attribute__((address_space(16776960))) unsigned int *arg_b = (gmem + ((XCL_SIZE_T)args->b >> 2));
  unsigned int arg_n_elements = args->n_elements;
  __SPIR_kernelA(rt_info, arg_a, arg_b, arg_n_elements, pipe_a, pipe_a_count, pipe_b, pipe_b_count);
  return;
}

void
__AESL_work_groupA(__attribute__((address_space(16776960))) volatile unsigned int* gmem, __attribute__((address_space(16776963))) unsigned int* pipe_a, __spir_uint_t pipe_a_count, __attribute__((address_space(16776963))) unsigned int* pipe_b, __spir_uint_t pipe_b_count, krnl_read_args_t *args)
{
...
CALL_WORK_ITEM_FUNC(gmem, pipe_a, pipe_a_count, pipe_b, pipe_b_count, &rt_info, args);
